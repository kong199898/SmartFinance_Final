...
class OtherExpenseViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(editOtherExpenseNotification), name: Notification.Name("editOtherExpense"), object: nil)
    }
    
    @objc func editOtherExpenseNotification(_ notification: Notification){
        isEdit = true
        ...
        DescriptionField.text = String(notification.userInfo?["other"] as! String)
    }
    ...
    func showForm(){
        ...
        DescriptionField = UITextField(frame: CGRect(x: 0,
        ...
        let AmountPerYearLabel = UILabel(frame: CGRect(x: 0,
                                                       ...
                                                       width: screenWidth*0.9,
                                                       height: screenHeight*0.04))
        AmountPerYearLabel.text = "Amount Per Year"
        ...
        let WhenLabel = UILabel(frame: CGRect(x: 0,
                                              y: screenHeight*0.01+screenHeight*0.04+screenHeight*0.06+screenHeight*0.04+screenHeight*0.06+screenHeight*0.04+screenHeight*0.06,
                                              width: screenWidth*0.9,
                                              height: screenHeight*0.04))
        ...
        AgeSlider = UISlider(frame: CGRect(x: 0,
                                           y: screenHeight*0.01+screenHeight*0.04+screenHeight*0.06+screenHeight*0.04+screenHeight*0.06+screenHeight*0.04+screenHeight*0.06+screenHeight*0.04+screenHeight*0.04,
                                           width: screenWidth*0.9,
                                           height: screenHeight*0.04))
        ...
        AgeSldierValue = UILabel(frame: CGRect(x: 0,
                                               y: screenHeight*0.01+screenHeight*0.04+screenHeight*0.06+screenHeight*0.04+screenHeight*0.06+screenHeight*0.04+screenHeight*0.06+screenHeight*0.04,
                                               width: screenWidth*0.9,
                                               height: screenHeight*0.04))
        AgeSldierValue.text = "Age " + Int(AgeSlider.value).description + " for life"
    ...
    func showButton(){
        ...
        let CancelButton = MDCButton(frame: CGRect(x: 0,
                                                   y: screenHeight*0.45+screenHeight*0.06,
                                                   width: screenWidth*0.9,
                                                   height: screenHeight*0.05))
    ...
    func validateInput() -> Bool{
        ...
        if DescriptionField.text == ""{
            showMessage(alert: "Invalid Description", message: "Please input a description.")
            return false
        }
    ...
    @objc func SubmitButtonTapped(_ sender: UIButton){
        if validateInput(){
            if isEdit!{
                updateItem(item: editItem!, newamount: Int(AmountPerYearField.text!) ?? 0, newfrequency: frequency!, newStartingAge: Int(AgeSlider.value), newother: DescriptionField.text!)
                dismiss(animated: true, completion: nil)
            }else{
                createItem(type: "Other Expense", amount: Int(AmountPerYearField.text!) ?? 0, frequency: frequency!, StartingAge: Int(AgeSlider.value), other: DescriptionField.text!)
                dismiss(animated: true, completion: nil)
            }
        }
    }
    ...
    func createItem(type:String, amount:Int, frequency:String, StartingAge:Int, other:String){
    ...
    func updateItem(item: TheSpendingGoal, newamount:Int, newfrequency:String, newStartingAge:Int, newother:String){
